                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group {{ $errors->first('prov_penyelenggara') ? 'has-error' : '' }}">
                            <label for="prov_penyelenggara" class="label-control required">Lokasi</label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group {{ $errors->first('kota_penyelenggara') ? 'has-error' : '' }}">
                            <label for="kota_penyelenggara" class="label-control"></label>
                            <select name="kota_penyelenggara" required
                            id="kota_penyelenggara" class="form-control">
                                @if(old('prov_penyelenggara'))
                                    @foreach($kota as $key)
                                        @if($key->id_prov == old('prov_penyelenggara'))
                                        <option value="{{ $key->id }}" 
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#prov_penyelenggara').select2(); // Select2 Provinsi
