...
<section class="content-header">
    <h1>
        Tambah Tim Produksi PPKB P3S Mandiri
            ...
            <form action="" class="form-horizontal" id="formAdd" name="formAdd"
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2" style="text-align:right">
                            ...
                            <!-- <div class="checkbox" style="padding-top: 0px;color:red;text">
                                <label>
                                    Badan Usaha
                                </label>
                                <input type="checkbox" id="ckbadanusaha" style="margin: 0 0 0 0;height:16px !important">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                ...
                                <select class="form-control select2" name="leveltimprod" id="leveltimprod"
                                    style="width: 100%;">
                                    <option value="" disabled selected>*Level_P</option>
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                ...
                                <select class="form-control select2" name="id_jenis_usaha" id="id_jenis_usaha"
                                    style="width: 100%;">
                                    <option value="" selected>Jenis Usaha</option>
                                    @foreach($jenisUsaha as $key)
                                    <option value="{{ $key->id }}">{{ $key->nama_jns_usaha }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                ...
                                <select class="form-control select2" name="id_pjk3" id="id_pjk3" style="width: 100%;">
                                    <option value="" selected>PJK3</option>
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                ...
                                <select class="form-control select2" name="gol_harga" id="gol_harga"
                                    style="width: 100%;">
                                    <option value="" disabled selected>Golongan Harga Produksi</option>
                ...
                <div class="box-footer" style="text-align:center">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="{{ url('timproduksi/all') }}" class="btn btn-md btn-default"><i
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (level != 1 && data.length <= 0) {
                        ...
                        $('#timprodatas').val($('#timprodatas option:eq(1)').val()).trigger(
                            'change.select2');
