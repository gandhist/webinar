    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
      ...
      {{-- <main role="main" class="container">
        <div class="jumbotron">
          ...
          <p class="lead">
              Untuk mencari sertifikat, anda dapat membuka link yang telah terkirim di email <br>
              jika tidak mendapatkan email, silahkan cari dengan no sertifikat dan email yang terdaftar saat pendaftaran
          </p>
