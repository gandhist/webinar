                ...
                <table style="table-layout: fixed;" width=780 border=0 cellspacing=0 cellpadding=0>
                    ...
                    <tr>
                        <td colspan="48" style="text-align: center; vertical-align: middle;">
                            ...
                            <p style="margin-bottom: -3px;">
                                <div style="margin-top:-8px; font-size: 20px; font-family: Verdana, Geneva, Tahoma, sans-serif; color: crimson;">WEBINAR:</div>
                                <div style="margin-top:-8px; font-size: 25px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-weight: bold; color: crimson;">TANTANGAN, PELUANG DAN HARAPAN INDUSTRI KONSTRUKSI INDONESIA</div>
                                <div style="margin-top:-8px; font-size: 25px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-weight: bold; color: crimson;">MENGHADAPI ANCAMAN GELOMBANG KEDUA (SECOND WAVE) COVID-19</div>
                            </p>
                    ...
                    <tr>
                        <td colspan="48" style="text-align: center; vertical-align: middle;">
                                ...
                                <b>Jakarta, 18 Juli 2020</b>
                            
                        </td>
                    </tr>
                    <tr>
                        <td colspan="16" style="margin-top: -3px; text-align: center; vertical-align: top; margin-bottom: -3px;">
                            <img src= "QR_ludy18.png" height=60px><br>
                            <b>Ir. Ludy Eqbal Almuhamadi</b><br>
                        ...
                        <td colspan="16" style="margin-top: -3px;text-align: center; vertical-align:top; margin-bottom: -3px;">
                            <img src= "QR_irwin18.png" height=60px><br>
