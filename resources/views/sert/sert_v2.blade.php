                ...
                <table style="table-layout: fixed;" width=780 border=0 cellspacing=0 cellpadding=0>
                    <tr>
                        <td colspan="6" style="text-align: center;vertical-align: middle;">
                            <a href="https://asttatindo.org/" target="_blank"><img src="asttatindo.jpg" height="50px"></a>
                        </td>
                    ...
                    <tr>
                        <td colspan="6" style="text-align: center; vertical-align: middle;">
                            <a href="https://astekindo.or.id" target="_blank"><img src="astekindo.jpeg" width="60px"></a>
                        </td>
                    ...
                    <tr>
                        <td colspan="48" style="text-align: center; vertical-align: middle;">
                            ...
                            <p >
                                <span style="font-size: 20px; font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; color: crimson;">KNOWLEDGE SHARING & DISCUSSION:</span><br>
                                <span style="font-size: 24px; font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; color: crimson;">HAPPINESS ORGANIZATIONAL & COMMUNICATION MANAGEMENT</span><br>
                                <span style="font-size: 24px; font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; color: crimson;">IN CONSTRUCTION PROJECT</span><br>
                    ...
                    <tr>
                        <td colspan="48" style="text-align: center; vertical-align: middle;">
                            <p style="margin-top: 2px; margin-bottom:2px ">
                                ...
                                DPD ASTTATINDO RIAU - DPD ASTEKINDO RIAU - DPN PPK-K3
                            </span>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="48" style="text-align: center; vertical-align: middle;">
                                ...
                                <b>Jakarta, 27 Juni 2020</b>
                            
                        </td>
                    </tr>
                    <tr>
                        <td colspan="16" style="margin-top: -3px; text-align: center; vertical-align: top; margin-bottom: -3px;">
                            <img src= "viby.png" height=60px><br>
                            <b>Ir. Desiderius Viby Indrayana, MM., MT.</b><br>
                            Ketua Umum DPD ASTTATINDO Riau
                        </td>
                        <td colspan="16" style=" margin-top: -3px; text-align: center; vertical-align: top;">
                            
                        </td>
                        <td colspan="16" style="margin-top: -3px;text-align: center; vertical-align:top; margin-bottom: -3px;">
                            <img src= "irwin.png" height=60px><br>
                            <b>Irwin Yudha Sijabat, ST</b><br>
                            Ketua Panitia
                        </td>
                    </tr>
