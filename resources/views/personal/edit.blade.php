                ...
                @method('PATCH')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input value="{{ $personal[0]['nama'] }}" id="nama" name="nama" type="text" required class="form-control" placeholder="Nama Lengkap">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input value="{{ $personal[0]['email'] }}" id="email" name="email" type="email" required class="form-control {{ $errors->first('email') ? 'is-invalid' : '' }}" aria-describedby="emailHelp" placeholder="Alamat Email">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input value="{{ $personal[0]['no_hp'] }}" id="no_hp" name="no_hp" type="number" required class="form-control" placeholder="No Handphone">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input value="{{ $personal[0]['alamat'] }}" id="alamat" name="alamat" type="text" required class="form-control" placeholder="Alamat">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input value="{{ $personal[0]['pekerjaan'] }}" id="pekerjaan" name="pekerjaan" type="text" required class="form-control" placeholder="Pekerjaan">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input value="{{ $personal[0]['instansi'] }}" id="instansi" name="instansi" type="text" required class="form-control" placeholder="Instansi (tempat kerja/sekolah)">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input value="{{ $personal[0]['tgl_lahir'] }}" id="tgl_lahir" name="tgl_lahir" type="text" required class="form-control" placeholder="YYYY/MM/DD">
