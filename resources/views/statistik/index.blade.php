                        ...
                        <tbody>
                            @foreach($blasting as $key)
                                <tr>
                                    ...
                                    <td><a href="{{ url('statistik', $key->id) }}">{{( isset($key->seminar) ? $key->seminar->nama_seminar : '' ) . " - " . (isset($key->seminar) ? \Carbon\Carbon::parse($key->seminar->tgl_awal)->format('d F Y') : '' )}}</a></td>
