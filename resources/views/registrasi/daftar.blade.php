...
<style>
    ...
    @-webkit-keyframes glowing {
        ...
        50% {
            ...
            -webkit-box-shadow: 0 0 40px #343a40;
        }
    ...
    @-moz-keyframes glowing {
        ...
        50% {
            background-color: #343a40;
            -moz-box-shadow: 0 0 40px #343a40;
        }
        ...
        <form action="{{ url('registrasi/save', $data->id) }}" class="form-horizontal" id="formRegist" name="formRegist"
                ...
                <div class="col-lg-8 card" style="width: 100%;background-color:#b7d0ed">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input oninvalid="this.setCustomValidity('Masukkan Nama Lengkap')"
                                oninput="setCustomValidity('')" value="{{ old('nama') }}" id="nama" name="nama"
                                type="text" required class="form-control" placeholder="Nama Lengkap">
                ...
                <div class="col-lg-8 card" style="width: 100%;background-color:#b7d0ed">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input oninvalid="this.setCustomValidity('Masukkan Email ')" oninput="setCustomValidity('')"
                                value="{{ old('email') }}" id="email" name="email" type="email" required
                ...
                <div class="col-lg-8 card" style="width: 100%;background-color:#b7d0ed">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input oninvalid="this.setCustomValidity('Masukkan No HP')" oninput="setCustomValidity('')"
                                value="{{ old('no_hp') }}" id="no_hp" name="no_hp" type="number" required
                ...
                <div class="col-lg-8 card" style="width: 100%;background-color:#b7d0ed">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input oninvalid="this.setCustomValidity('Masukkan Nama Institusi')"
                                oninput="setCustomValidity('')" value="{{ old('instansi') }}" id="instansi"
                                name="instansi" type="text" required class="form-control"
                                placeholder="Tempat Kerja atau Tempat Studi (spesifik)">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 card" style="width: 100%;background-color:#b7d0ed">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="pekerjaan" class="label-control required"><b>Jabatan pada institusi
                                    terkait</b></label>
                            <input oninvalid="this.setCustomValidity('Masukkan Nama Jabatan')"
                                oninput="setCustomValidity('')" value="{{ old('pekerjaan') }}" id="pekerjaan"
                                name="pekerjaan" type="text" required class="form-control" placeholder="Jabatan">
