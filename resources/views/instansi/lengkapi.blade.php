...
<section class="content-header">
    <h1>
        Lengkapi Data Pimpinan
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#"> Daftar</a></li>
        <li class="active"><a href="#"> Instansi</a></li>
        <li class="active"><a href="#"> Lengkapi</a></li>
    </ol>
</section>
        ...
        <div class="container-fluid">
            <div class="jumbotron"  style='padding-top:1px'>
                ...
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ ($errors->first('instansi')) ? ' has-error' : '' }}">
                                ...
                                <select
                                class="form-control" id="instansi" name="instansi" disabled>
                            <option value="{{$instansi->id}}">{{$instansi->nama_bu}}</option>
                                </select>
                    ...
                    <input type="hidden" name="id" value="{{ $id_personal }}">
