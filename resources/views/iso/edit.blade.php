                    ...
                    @csrf
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input name="nama_bu" id="nama_bu" type="text" class="form-control" value="{{old('nama_bu')}}" placeholder="Nama Seminar">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea name="alamat" class="form-control" id="alamat" placeholder="Alamat Lengkap Tanpa Kota dan Provinsi"></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input name="tipe_iso" id="tipe_iso" type="text" class="form-control" value="{{old('tipe_iso')}}" placeholder="Tipe ISO">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea name="scope" class="form-control" id="scope" placeholder="Ruang Lingkup/Scope"></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input name="no_sert" id="no_sert" type="text" class="form-control" value="{{old('no_sert')}}" placeholder="No Sertifikat">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input name="tgl_sert" id="tgl_sert" autocomplete="off" data-provide="datepicker" data-date-format="yyyy/mm/dd" type="text" class="form-control" value="{{old('tgl_sert')}}" placeholder="Tanggal Sertifikat">
