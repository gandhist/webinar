                ...
                <table class="content" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="padded">
                            ...
                            <p>Silahkan menggunakan link berikut untuk mereset password Anda.</p>
                            <p style="text-align:center;"><a href="{{ url('reset-password/'.$details['reset']['token']) }}" class="btn">Reset Password</a></p>
                            <br>
