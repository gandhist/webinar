                ...
                <table class="content" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="padded">
                            ...
                            <p>Bersama ini kami sampaikan tentang rencana jadwal kegiatan webinar yang akan diselenggarakan oleh P3S Mandiri.
                            {{$detail['seminar']['nama_seminar']}} dengan judul "<b>{{$detail['tema']}}</b>". Yang akan diadakan pada {{ $hari.', '. $detail['tanggal']}}
                            jam {{$detail['jam']}} WIB sampai selesai.</p>
                            <p>Dapatkan sertifikat dan modul dengan biaya investasi sebesar <b>Rp. {{number_format($detail['seminar']['biaya'],0,".",",")}}</b> </p>
                            <br>
