...
class SeminarController extends Controller
{
    ...
    public function mulai($id){
        ...
        return redirect()->back()->with('alert',"Seminar sudah berhasil di mulai");
    }
    ...
    public function downloadPenyelenggaraAll() {
        //
    ...
    public function blast(Request $request, $id) {
        ...
        foreach($target as $key){
            ...
            // if( !(isset($peserta_seminar)) ){
                ...
                if($seminar->is_free == 1){
                    dispatch(new \App\Jobs\BlastingBerbayar($detail, $link));
                } else {
